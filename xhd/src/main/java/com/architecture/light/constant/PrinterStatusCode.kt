...
object PrinterStatusCode {
    ...
    private val errorCodeMap = mapOf(
        CODE__101 to "打印机离线",
        CODE__1 to "传入的打印机状态长度错误",
        CODE__5 to "不支持查询打印机状态",
        CODE__8 to "打印机使用者类型内存分配失败",
        CODE__11 to "打印机SMLLD使用授权不通过",
        CODE__99 to "打印机未知异常错误",
        ...
        CODE_25 to "打印机粉盒用尽",
        CODE_26 to "打印机出纸口卡纸",
        CODE_27 to "打印机中间卡纸未排除",
        CODE_28 to "打印机出纸口卡纸未排除",
        CODE_29 to "打印机中间卡纸",
        CODE_31 to "打印机双面单元卡纸",
        CODE_32 to "打印机双面单元未安装",
        CODE_33 to "打印机无匹配纸盒",
        CODE_34 to "打印机纸盒未安装",
        CODE_35 to "打印机纸盒缺纸(打印中)",
        CODE_36 to "打印机纸盒无匹配纸张",
        CODE_37 to "打印机进纸处卡纸",
        CODE_38 to "打印机纸盒设定纸张与实际纸张不匹配",
        CODE_39 to "打印机纸盒缺纸(打印机待机(就绪)中)",
        CODE_41 to "打印机未安装鼓组件",
        CODE_42 to "打印机鼓组件不匹配",
        CODE_43 to "打印机鼓组件用尽",
        CODE_44 to "打印机自动进纸盒缺纸",
        CODE_45 to "打印机手动进纸盒缺纸",
        CODE_46 to "打印机进纸失败",
        CODE_47 to "打印机纸型不匹配",
        CODE_48 to "打印机双面打印出现纸型不匹配",
        CODE_49 to "打印机纸张来源与实际进纸不匹配错误",
        CODE_77 to "打印机未知异常状态",
    )
