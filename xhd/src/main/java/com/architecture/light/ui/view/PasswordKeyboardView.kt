...
class PasswordKeyboardView @JvmOverloads constructor(
    context: Context,
    ...
    private fun confirm() {
        listener?.confirm(password.toString())
    }
    ...
    fun bindEditText(editText: EditText) {
        ...
        editText.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                ...
                listener?.textChanged(password.toString())
            }
        })
    }
    ...
    interface OnInputListener {
        fun textChanged(password: String)
