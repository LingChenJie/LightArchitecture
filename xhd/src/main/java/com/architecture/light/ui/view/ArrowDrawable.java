...
public final class ArrowDrawable extends Drawable {
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            ...
            mArrowHeight = (int) context.getResources().getDimension(com.android.architecture.R.dimen.dp_6);
            mRadius = (int) context.getResources().getDimension(com.android.architecture.R.dimen.dp_4);
            mShadowSize = 0;
            mArrowOffsetX = 0;
            mArrowOffsetY = 0;
