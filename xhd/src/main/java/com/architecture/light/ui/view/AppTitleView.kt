...
import com.architecture.light.databinding.ViewTitleAppBinding
...
class AppTitleView @JvmOverloads constructor(
    ...
    private val binding: ViewTitleAppBinding by lazy {
        ViewTitleAppBinding.inflate(LayoutInflater.from(context), this, true)
    }
