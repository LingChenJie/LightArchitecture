package com.light.xhd.ui.adapter
...
import com.light.xhd.databinding.ItemHomeTabBinding

/**
 * Created by SuQi on 2022/8/19.
 * Describe:
 */
class HomeTabAdapter(private val fixedWidth: Boolean = true) : BaseAdapter<String, ItemHomeTabBinding>() {
