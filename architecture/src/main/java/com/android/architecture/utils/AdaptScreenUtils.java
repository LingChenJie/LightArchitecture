...
public final class AdaptScreenUtils {
    ...
    public static int pt2Px(float ptValue) {
        DisplayMetrics metrics = AppUtils.getApp().getResources().getDisplayMetrics();
    ...
    private static void setAppDmXdpi(final float xdpi) {
        AppUtils.getApp().getResources().getDisplayMetrics().xdpi = xdpi;
    }
        ...
        if (!isInitMiui) {
            ...
            if ("MiuiResources".equals(simpleName) || "XResources".equals(simpleName)) {
                try {
                    ...
                    Log.e("AdaptScreenAppUtils", "no field of mTmpMetrics in resources.");
                }
            }
            isInitMiui = true;
            return ret;
