...
import com.architecture.light.databinding.ActivityNestedAppbarBinding
 ...
 * Version: 1
 */
class NestedAppBarActivity : AppActivity() {

    private val binding: ActivityNestedAppbarBinding by binding()
