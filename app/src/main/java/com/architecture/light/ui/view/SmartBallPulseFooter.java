...
public final class SmartBallPulseFooter extends SimpleComponent implements RefreshFooter {
    ...
    public SmartBallPulseFooter(Context context, @Nullable AttributeSet attrs) {
        ...
        mTextWidth = mPaint.measureText(getContext().getString(com.architecture.light.R.string.common_no_more_data));
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (mNoMoreData) {
            ...
            canvas.drawText(getContext().getString(com.architecture.light.R.string.common_no_more_data), (width - mTextWidth) / 2, (height - mPaint.getTextSize()) / 2, mPaint);
        } else {
