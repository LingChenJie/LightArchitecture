...
public abstract class PermissionCallback implements OnPermissionCallback {
    ...
    protected void showPermissionDialog(List<String> permissions) {
        ...
        new MessageDialog.Builder(activity)
                .title(activity.getString(R.string.common_permission_alert))
                .message(getPermissionHint(activity, permissions))
                .confirmText(activity.getString(R.string.common_permission_goto))
                .setCancelable(false)
                .onConfirm(() -> {
